...
return [
    ...
    | por la clase Validator. Algunas de estas reglas tienen múltiples
    | versiones, como las reglas de tamaño. Estos mensajes se pueden ajustar
    | libremente.
    |
    */
    ...
    | líneas. Esto permite tener rápidamente un mensaje personalizado para
    | una regla específica de un atributo.
    |
    */
    ...
    | por algo más legible, como "Dirección de correo" en vez de "email".
    | Esto ayuda a que el mensaje sea más expresivo.
    |
    */
